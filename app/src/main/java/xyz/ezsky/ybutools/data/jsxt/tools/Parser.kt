...
abstract class Parser(val source: String) {
    ...
    class coursedata(
       val base:ArrayList<CourseBaseBean>,
       val detail:ArrayList<CourseDetailBean>
    )

    fun getCourse(): coursedata {
        convertCourse()

        return coursedata(_baseList,_detailList)
    }
